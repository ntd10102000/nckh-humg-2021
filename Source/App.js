(function() {
    ...
    var initialPosition = new Cesium.Cartesian3.fromDegrees(13.047533, 52.4098385, 1000.082799425431);
    ...
    var geocachePromise = Cesium.KmlDataSource.load('./Source/SampleData/Lod1PotsdamBuilding_Tile_0_0_geometry.kml', kmlOptions);
    ...
    var city = viewer.scene.primitives.add(new Cesium.Cesium3DTileset({ url: Cesium.IonResource.fromAssetId(16421) }));

    var promise = Cesium.IonResource.fromAssetId(405558)
